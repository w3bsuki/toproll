<script lang="ts">
	...
	import type { Battle, BattleParticipant } from '$lib/types/index';
	...
	let winnerElement = $state<HTMLElement | null>(null);
							...
							<div class="flex flex-col items-center">
								...
								>
									{#if sortedParticipants.indexOf(participant) < 3}
										{@const WinnerIcon = getWinnerIcon(sortedParticipants.indexOf(participant) + 1)}
										<WinnerIcon class="h-5 w-5" />
									{:else}
