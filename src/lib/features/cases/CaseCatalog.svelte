<script lang="ts">
	...
	import type { Case, CaseItem } from '$lib/types/index';
	...
	function getCaseTypeIcon(caseName: string): typeof Trophy {
...
<div class="space-y-6 {className || ''}">
	...
	<div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
		{#each cases as caseData (caseData.id)}
			...
			<div class="group" transition:fade={{ duration: 300 }}>
				<div
	...
	{#if showCasePreview && selectedCase}
		<div class="bg-background/80 fixed inset-0 z-50 flex items-center justify-center p-4" transition:fade>
			<div class="w-full max-w-2xl" transition:fade={{ duration: 300 }}>
