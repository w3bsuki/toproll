...
-- Fixes: Steam login "Missing nonce parameter" error
...
GRANT SELECT, INSERT, DELETE ON auth_nonces TO authenticated;
GRANT SELECT, INSERT, DELETE ON auth_nonces TO anon;
